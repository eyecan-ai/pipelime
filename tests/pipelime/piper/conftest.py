...
from pipelime.sequences.validation import SampleSchema
...
def piper_commands(data_folder):
    ...
    return {
        ...
        "wrong_outputs": {
            "command": build_python_command("wrong_outputs.py"),
            "valid": False,
            "exception": KeyError,
        },
        "wrong_inputs": {
            "command": build_python_command("wrong_inputs.py"),
            "valid": False,
            "exception": KeyError,
        },
        "not_a_piper": {
            "command": build_python_command("not_a_piper.py"),
            "valid": False,
            "exception": TypeError,
        },
        "no_command_name": {
            "command": build_python_command("no_command_name.py"),
            "valid": True,
            "exception": None,
        },
    }
