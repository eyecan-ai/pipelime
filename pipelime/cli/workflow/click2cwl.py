...
@click.option("--fchoice/--no-fchoice", default=True, type=bool, help="TRUE to activate forward interactive choice")
@click.option("-f", multiple=True, type=str, help="Forwards, used only if the interactive choice is disabled")
@click.option("--folder", default="", type=str, help="Output folder to save the cwl. Leave empty to use default folder")
def click2cwl(
    script,
    name,
    alias,
