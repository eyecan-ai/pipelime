...
@click.option("--cfg_file", required=True, type=str, help="The configuration input file, XConfig placeholders will be prompted to the user")
@click.option("--folder", default=None, type=str, help="Folder of the cwl nodes. Leave empty to use default folder")
@click.option('--fill/--no-fill', default=True, type=bool, help='Do not fill the workflow steps with the cwl nodes path')
